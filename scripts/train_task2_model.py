...
def run_training(
    ...
    table_path = Path(features_config.get("table_path", "artifacts/source_features.csv"))
    ...
    label_column = features_config.get("label_column", "label")
    ...
    alignment = _parse_alignment_config(config.get("alignment"))
    split = _parse_split_config(config.get("split"))
    model = _parse_model_config(config.get("model"))
    cross_validation = _parse_cross_validation_config(config.get("cross_validation"))
    interpretability_config = config.get("interpretability", {}) or {}
